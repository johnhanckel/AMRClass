...
#rthresh = 1510 # og: 1400
#cthresh = 1680 # og: 1600
#lthresh = 1570 # og: 1500
...
def main():
	...
	while not rospy.is_shutdown():
		...
		vel.angular.z = direction;
		vel_pub.publish(vel)
		print("speed:{:0.2f}\tdelcs: {:0.2f}\tdelcs_thresh: {:0.2f}\tcentersensor:{:0.2f}\t\tprev_hit:{}\t(l,c,r):({},{},{})".format(speed,delcs,delcs_thresh,centersensor,prev_hit,lhit,chit,rhit))
		rate.sleep()
